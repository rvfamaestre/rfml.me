# Revisión del contenido · 14 septiembre 2026
...
| labor | [eci-tp1](https://github.com/rvfamaestre/eci-tp1) (`mvp.py` e informe) | Regresión entre países con las tendencias en logaritmos, igual que el código. Figura 1980–2000 del informe. Matplotlib añadido por la figura. |
...
Probado con Playwright en 390×844 y 375×667: deslizar en los dos sentidos, límites de la primera y la última página, gesto vertical, arrastre corto, deslizar desde un cuadro y desde la ficha, ficha arriba o abajo sin tapar nunca su cuadro, cambiar de cuadro, tocar la ficha para abrir, cerrar y fórmulas que caben en pantalla. Se corrigió que la ficha de un cuadro desaparecía al tocar otro, por el blur del cuadro anterior.
